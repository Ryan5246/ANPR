...
# video_path = 'Testing Videos/trainingsvideo.avi'  Change video path here or use live camera feed
...
# Initialize the window first with resizable properties
...
# Attach the UI Controls directly to the newly sized window
